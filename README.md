...
- [TACTIC-CAGE suggestion disposition: Qwen evidence map, theory corrections, and active WFA checkpoint](docs/TACTIC_CAGE_REVIEW_SUPPLEMENT_2026-09-02.md)
...
- [Blocked N18-307 v3 independent audit: byte-ledger/non-codec distinction, metadata topology, runtime, and repeated reads](research/tactic_actual_coarse_n18_v3_independent_audit_20260902/AUDIT_REPORT.md)
- [Blocked TACTIC-DH384 v2 independent audit: undefined finite code, coarse binding, publication, and portability](research/tactic_conditional_dyadic_coset_v2_independent_audit_20260902/AUDIT_REPORT.md)
...
- [UWFA-SC v8 real-Qwen attempt: authenticated runtime abort before WFA fitting](research/uwfa_sc_v8_qwen_early_gate_v0_qwen_abort_20260902f_audit/README.md)
- [UWFA-SC v9 primary-only Qwen gate and independent nonpromoting source audit](research/uwfa_sc_v9_qwen_primary_gate_v0_independent_audit_20260902/AUDIT.md)
