#!/usr/bin/env python3
"""Standard-library contracts and exact CPU reference for UWFA census v8.
...
DESIGN_SCHEMA = "unifilar-wfa-entropy-census-design-v8"
RESULT_SCHEMA = "unifilar-wfa-entropy-census-result-v8"
REVIEW_SCHEMA = "unifilar-wfa-entropy-census-independent-source-review-v8"
STREAM_LOCK_SCHEMA = "unifilar-wfa-canonical-stream-lock-v8"
CONTROL_LOCK_SCHEMA = "unifilar-wfa-gaussian-control-panel-lock-v8"
AUTHORIZATION = "OPEN_AUTHENTICATED_UNIFILAR_WFA_CENSUS_AFTER_INDEPENDENT_SOURCE_REVIEW_V8"
...
SPLIT_HASH_SEED = b"UWFA-V8-NESTED-SPLIT-2026-09-02"
...
def deserialize_model(packet: bytes) -> tuple[Candidate, list[int]]:
    ...
    require(magic == b"UWFAV8\x00\x00" and version == 3, "model magic/version")
...
def parent_commit_marker_name(final_name: str) -> str:
    ...
    digest = sha256_bytes(b"UWFA-V8-COMMIT-NAME\x00" + final_name.encode("utf-8"))
...
def committed_directory_root(source_manifest_sha256: str, members: list[dict[str, Any]]) -> str:
    ...
    return sha256_bytes(b"UWFA-V8-HELD-DIRECTORY-ROOT\x00" + body)
...
class CompletionLastOutput:
    ...
    def __init__(self, parent: RetainedOutputParent, final_name: str, transaction_id: str):
        ...
        anchor_suffix = sha256_bytes(b"UWFA-V8-COMMIT-ANCHOR\x00" + final_name.encode("utf-8"))[:16]
        self.commit_anchor_name = f".uwfa-commit-anchor-v8-{self.transaction_id}-{anchor_suffix}.incomplete"
    ...
    def __enter__(self) -> "CompletionLastOutput":
        ...
        self.write_new("RUN_STATE.json", pretty_json({
            "schema": "unifilar-wfa-run-state-v8",
            "complete": False,
    ...
    def _parent_commit_record(
        ...
        *,
        ...
        return seal_record(
            {
                "schema": "unifilar-wfa-parent-commit-v8",
