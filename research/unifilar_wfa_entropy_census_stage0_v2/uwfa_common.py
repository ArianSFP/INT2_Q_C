#!/usr/bin/env python3
"""Standard-library contracts and exact CPU reference for UWFA census v2.
...
DESIGN_SCHEMA = "unifilar-wfa-entropy-census-design-v2"
RESULT_SCHEMA = "unifilar-wfa-entropy-census-result-v2"
REVIEW_SCHEMA = "unifilar-wfa-entropy-census-independent-source-review-v2"
STREAM_LOCK_SCHEMA = "unifilar-wfa-canonical-stream-lock-v2"
CONTROL_LOCK_SCHEMA = "unifilar-wfa-gaussian-control-panel-lock-v2"
AUTHORIZATION = "OPEN_AUTHENTICATED_UNIFILAR_WFA_CENSUS_AFTER_INDEPENDENT_SOURCE_REVIEW_V2"
...
SPLIT_HASH_SEED = b"UWFA-V2-NESTED-SPLIT-2026-09-01"
...
def deserialize_model(packet: bytes) -> tuple[Candidate, list[int]]:
    ...
    require(magic == b"UWFAV2\x00\x00" and version == 2, "model magic/version")
...
class CompletionLastOutput:
    ...
    def __enter__(self) -> "CompletionLastOutput":
        ...
        self.write_new("RUN_STATE.json", pretty_json({"schema": "unifilar-wfa-run-state-v2", "complete": False}))
        return self
    ...
    def complete(self, members: list[dict[str, Any]], source_manifest_sha256: str) -> dict[str, Any]:
        ...
        record = seal_record(
            {
                "schema": "unifilar-wfa-completion-v2",
