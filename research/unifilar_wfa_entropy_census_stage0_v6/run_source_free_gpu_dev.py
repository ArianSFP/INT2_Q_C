...
common = load("uwfa_v6_gpu_dev_common", "uwfa_common.py")
protocol = load("uwfa_v6_gpu_dev_protocol", "protocol.py")
semantic = load("uwfa_v6_gpu_dev_semantic", "universal_adapter.py")
codec = load("uwfa_v6_gpu_dev_codec", "container_codec.py")
stage = load("uwfa_v6_gpu_dev_stage", "stage0_census.py")
cupy_backend = load("uwfa_v6_gpu_dev_backend", "cupy_backend.py")
envelope = load("uwfa_v6_gpu_dev_envelope", "result_envelope.py")
...
def main() -> int:
    ...
    if arguments.identity_only:
        # The strict V6 environment boundary requires a real, measured resource
    ...
    receipt = {
        "schema": "uwfa-sc-v6-direct-copy-development-gpu-receipt",
    ...
    try:
        ...
        verified_output = envelope.verify_completed_under_parent(
            common,
            parent,
