#!/usr/bin/env python3
"""Strict bounded records for the source-only UWFA-SC v6 producer.
...
def validate_score_receipt(
    ...
    *,
    ...
    if row["schema"] != "uwfa-bound-baseline-score-v6" or row["status"] != "PASS_INDEPENDENT_BASELINE_SCORE":
...
def validate_control_binding(
    ...
    *,
    ...
    if row["schema"] != "uwfa-matched-gaussian-control-binding-v6":
