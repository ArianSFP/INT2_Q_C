# UWFA-SC v7 independent bootstrap ABI
...
- the SHA-256 of an independent v7 source-review receipt whose schema is
  `unifilar-wfa-entropy-census-independent-source-review-v7`;
...
- `container_codec.py`: literal `UWFCV7` build/parse/rebuild/routed-read ledger;
...
6. Form connected components of the exact stream-owner bipartite graph; require
   ...
   all 150 cells, winner refit, exact literal
...
The literal result also carries a `uwfa-sc-v7-posterior-diagnostic-handoff`
