...
is consumable only when the retained parent contains the V7 commit marker and
...
class VerifiedOutputBundle:
    ...
    def _verify_and_hold(self) -> None:
        ...
        _require(marker["schema"] == "unifilar-wfa-parent-commit-v7", "parent commit marker schema")
        ...
        _require(complete["schema"] == "unifilar-wfa-completion-v7" and complete["status"] == "COMPLETE_LAST", "completion content schema/status")
