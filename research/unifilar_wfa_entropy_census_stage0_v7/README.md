# Universal UWFA-SC v7 — pre-review source-only producer
...
receipts remain unchanged. This v7 tree is
...
The only measured object is one complete `UWFCV7` byte string:
...
that measurement. Promotion requires pooled literal saving of at least
...
- an externally pinned v7 source audit;
