...
AUTHORIZATION = "EXECUTE_FROZEN_CBIB1_R3_LOCAL3060_QWEN_ONCE_R3_6B20D57E"
AUTHORITY_ROOT = Path(
    r"C:\INT2__compression\INT2_Q_C\research\same_layer_clustered_ib_entropy_gate_v0_qwen_deployment_20260903_r3_local_rtx3060_capability_20260903_r3"
)
...
AUTHORITY_STATUS = Path(
    r"C:\INT2__compression\tmp\CBIB1_R3_LOCAL3060_AUTHORITY_STATUS_20260903_R3_6B20D57E.json"
)
...
def validate_prerequisites(capability_manifest_sha: str) -> None:
    capability = authenticate_package(
        ...
        "same-layer-clustered-ib-r3-local-rtx3060-capability-manifest-v0-r3",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.authorization != AUTHORIZATION:
        print(json.dumps({"schema": "cbib1-r3-local3060-authority-hold-v0-r3",
    ...
    claim_raw = (json.dumps({
        "authorization_id": "CBIB1_R3_LOCAL3060_QWEN_ONCE_20260903_R3_6B20D57E",
        "capability_manifest_sha256": args.capability_manifest_sha256,
        "claimed_at_utc": datetime.now(timezone.utc).isoformat(),
        "deployment_manifest_sha256": DEPLOYMENT_MANIFEST,
        "schema": "cbib1-r3-local3060-authority-attempt-claim-v0-r3",
    ...
    try:
        ...
        child_argv = [str(PYTHON), "-I", "-B", str(BRIDGE), "--authorization",
                      "EXECUTE_CBIB1_R3_LOCAL3060_BRIDGE_ONCE_R3_6B20D57E"]
