...
def main() -> int:
    ...
    need(authority.get("schema") ==
         "same-layer-clustered-ib-r3-local-rtx3060-production-authority-v0-r3" and
         authority.get("authorization_id") ==
         "CBIB1_R3_LOCAL3060_QWEN_ONCE_20260903_R3_6B20D57E" and
         ...
         r"C:\INT2__compression\tmp\cbib1_r3_local3060_cupy_cache_20260903_r3_6b20d57e" and
         authority["paths"]["run_root"] ==
         r"C:\INT2__compression\tmp\cbib1_r3_local3060_qwen_once_20260903_r3_6b20d57e",
         "authority pins")
    ...
    need(receipt.get("schema") == "cbib1-r3-local3060-capability-source-only-test-v0-r3" and
    ...
    print(json.dumps({
        ...
        "schema": "cbib1-r3-local3060-capability-verification-v0-r3",
