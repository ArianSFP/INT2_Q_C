...
result=/workspace/uwfa_sc_v8_qwen_early_gate_v0_result_20260902c
log=/workspace/uwfa_sc_v8_qwen_early_gate_v0_result_20260902c.log
exit_receipt=/workspace/uwfa_sc_v8_qwen_early_gate_v0_result_20260902c.exit
...
/workspace/int2-cupy-venv/bin/python -I -B \
  /workspace/INT2_Q_C_qwen_v8_20260902a/research/uwfa_sc_v8_qwen_early_gate_v0/early_gate.py \
  --authorization RUN_EXACT_QWEN_EARLY_KILL_NO_CONTROLS_NO_CLAIM_V0 \
  --v8-package /workspace/INT2_Q_C_qwen_v8_20260902a/research/unifilar_wfa_entropy_census_stage0_v8 \
