# UWFA-SC v4 independent bootstrap ABI
...
- the SHA-256 of an independent v4 source-review receipt whose schema is
  `unifilar-wfa-entropy-census-independent-source-review-v4`;
...
- `container_codec.py`: literal `UWFCV4` build/parse/rebuild/routed-read ledger;
...
8. Supply a retained, authenticated output-parent descriptor. Create a hidden
   ...
   final name, or delete final members after a post-rename fault.
...
The literal result also carries a `uwfa-sc-v4-posterior-diagnostic-handoff`
