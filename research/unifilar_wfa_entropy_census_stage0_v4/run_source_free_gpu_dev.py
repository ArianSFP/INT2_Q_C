...
common = load("uwfa_v4_gpu_dev_common", "uwfa_common.py")
protocol = load("uwfa_v4_gpu_dev_protocol", "protocol.py")
semantic = load("uwfa_v4_gpu_dev_semantic", "universal_adapter.py")
codec = load("uwfa_v4_gpu_dev_codec", "container_codec.py")
stage = load("uwfa_v4_gpu_dev_stage", "stage0_census.py")
cupy_backend = load("uwfa_v4_gpu_dev_backend", "cupy_backend.py")
...
def main() -> int:
    ...
    receipt = {
        "schema": "uwfa-sc-v4-direct-copy-development-gpu-receipt",
