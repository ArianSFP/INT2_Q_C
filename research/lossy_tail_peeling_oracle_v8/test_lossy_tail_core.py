#!/usr/bin/env python3
"""CPU-only scientific/decision tests for lossy-tail v8."""
...
SPEC = importlib.util.spec_from_file_location("lossy_tail_v8_test_core", HERE / "lossy_tail_core.py")
CORE = importlib.util.module_from_spec(SPEC)
CORE.__dict__["__V8_CORE_CONTEXT__"] = {
...
class LossyTailOracleV8Tests(unittest.TestCase):
