#!/usr/bin/env python3
"""Isolated stdlib-only v8 stage/lock audit; no runtime/payload/output API."""
...
def fail(message: str) -> "NoReturn":  # type: ignore[name-defined]
    raise SystemExit(f"V8_AUDIT_REJECT: {message}")
...
def main() -> None:
    ...
    print(json.dumps({
        "event": "V8_SOURCE_ONLY_STAGE_AND_LOCK_PASS",
