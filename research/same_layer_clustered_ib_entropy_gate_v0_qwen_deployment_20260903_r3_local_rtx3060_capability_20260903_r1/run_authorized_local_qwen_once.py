...
AUTHORIZATION = "EXECUTE_FROZEN_CBIB1_R3_LOCAL3060_QWEN_ONCE_458A424A"
AUTHORITY_ROOT = Path(
    r"C:\INT2__compression\INT2_Q_C\research\same_layer_clustered_ib_entropy_gate_v0_qwen_deployment_20260903_r3_local_rtx3060_capability_20260903_r1"
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.authorization != AUTHORIZATION:
        print(json.dumps({"schema": "cbib1-r3-local3060-authority-hold-v0-r1",
    ...
    claim_raw = (json.dumps({
        "authorization_id": "CBIB1_R3_LOCAL3060_QWEN_ONCE_20260903_458A424A",
        "capability_manifest_sha256": args.capability_manifest_sha256,
        "claimed_at_utc": datetime.now(timezone.utc).isoformat(),
        "deployment_manifest_sha256": DEPLOYMENT_MANIFEST,
        "schema": "cbib1-r3-local3060-authority-attempt-claim-v0-r1",
    ...
    try:
        ...
        child_argv = [str(PYTHON), "-I", "-B", str(BRIDGE), "--authorization",
                      "EXECUTE_CBIB1_R3_LOCAL3060_BRIDGE_ONCE_458A424A"]
        ...
        status = {
            ...
            "schema": "cbib1-r3-local3060-authority-wrapper-v0-r1",
