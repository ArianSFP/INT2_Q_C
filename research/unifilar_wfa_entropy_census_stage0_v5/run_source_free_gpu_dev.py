...
common = load("uwfa_v5_gpu_dev_common", "uwfa_common.py")
protocol = load("uwfa_v5_gpu_dev_protocol", "protocol.py")
semantic = load("uwfa_v5_gpu_dev_semantic", "universal_adapter.py")
codec = load("uwfa_v5_gpu_dev_codec", "container_codec.py")
stage = load("uwfa_v5_gpu_dev_stage", "stage0_census.py")
cupy_backend = load("uwfa_v5_gpu_dev_backend", "cupy_backend.py")
...
def main() -> int:
    ...
    if arguments.identity_only:
        # The strict V5 environment boundary requires a real, measured resource
    ...
    receipt = {
        "schema": "uwfa-sc-v5-direct-copy-development-gpu-receipt",
